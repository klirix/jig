...
<main class="w-full bg-gradient-to-b from-gray-50 dark:from-gray-950 to-white dark:to-gray-800">
	<section
		class="bg-gradient-to-r from-gray-50 dark:from-gray-950 to-white dark:to-gray-800 mx-auto container lg:max-w-4xl py-52 px-4 md:px-28 shadow-lg"
	>
		<div class="pb-10">
			<h1
				class="unstyled text-6xl sm:text-8xl md:text-9xl leading-snug pb-3 font-semibold text-gray-900 dark:text-gray-100"
			>
				Welcome!
			</h1>
		</div>
		<div class=" space-y-4 px-2 md:px-0 text-xl text-gray-800 dark:text-gray-200">
			...
			<hr class=" mb-10" />
			<p>Install the client if you didn't do that already</p>
			<TabGroup>
